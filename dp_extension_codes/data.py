...
def get_data(data_path, img_size, batch_size, val_batch_size=1):
    ...
    trainloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=False, sampler = DistributedSampler(train_dataset))
    valloader = DataLoader(val_dataset, batch_size=val_batch_size, shuffle=False,sampler = DistributedSampler(val_dataset))
    testloader = DataLoader(test_dataset, batch_size=val_batch_size, shuffle=False, sampler = DistributedSampler(test_dataset))
